  ...
  constructor() {
    ...
    render(){
      return (
        ...
        <div className="row">
        <div className= "col" style={{background:'#ffffff', borderRadius:'50px', margin:'auto'}}>
        ...
        <div  className= "row" style={{marginTop:'20px', background:'#ffffff', borderRadius:'50px'}}><h2 style={{margin:'auto',color:this.state.backgroundColor}}>Blog</h2></div>
        <div  className= "row" style={{marginTop:'20px', background:'#ffffff', borderRadius:'50px'}}><h2 style={{margin:'auto',color:this.state.backgroundColor}}>Resume</h2></div>
        </div>
        </div>
        </div>
      );
